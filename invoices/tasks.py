...
from invoices.models import Invoice, NotificationLog, RecurringInvoice, Invoice, LineItem, Services
...
def scan_upcoming_reminders():
    ...
    for invoice in sent_invoices:
        ...
        for day_offset, reminder_type in reminder_schedule:
            ...
            # Prevent duplicate: check if this exact reminder was already sent
